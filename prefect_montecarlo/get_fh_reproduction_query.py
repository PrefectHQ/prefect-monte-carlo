...
Montecarlo query_get_fh_reproduction_query* tasks
"""
...
config_path = (
    ...
    / "configs"
    / "query"
    / "get_fh_reproduction_query.json"
)
return_fields_defaults = initialize_return_fields_defaults(config_path)


@task
async def query_get_fh_reproduction_query(  # noqa
    ...
    Args:
        ...
        metric: The metric which measured the anomaly.
    ...
    op_selection = op.get_fh_reproduction_query(
        **strip_kwargs(
    ...
    op_stack = ("getFhReproductionQuery",)
    op_selection = _subset_return_fields(
        op_selection, op_stack, return_fields, return_fields_defaults
    )

    result = await _execute_graphql_op(op, montecarlo_credentials)
    return result["getFhReproductionQuery"]
